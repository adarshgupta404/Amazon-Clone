const productsData = [
    ...
    },
    {
      id: '3',
      brand: 'Realme',
      name: 'realme narzo 50i (Carbon Black, 4GB RAM+64GB Storage) - with No Cost EMI/Additional Exchange Offers',
    ...
    },
    {
      id: '4',
      brand: 'Apple',
      name: 'Apple iphone electronics 13 Pro (128GB) - Sierra Blue',
    ...
    },
    {
      id: '5',
      brand: 'Samsung',
      name: 'Samsung Galaxy M53 5G (Deep Ocean Blue, 8GB, 128GB Storage) | 108MP',
    ...
    },
    {
      id: '6',
      brand: 'HP',
      name: 'HP 15s,11th Gen Intel Core i3-1115G4 8GB RAM/512GB SSD 15.6-inch(39.6 cm) Micro-Edge Anti-Glare FHD laptop electronics',
    ...
    },
    {
      id: '7',
      brand: 'vivo',
      name: 'ASUS VivoBook 15, 15.6-inch (39.62 cms) FHD, Intel Core i3-1005G1 10th Gen, Thin and Light laptop electronics',
    ...
    },
    {
      id: '9',
      brand: 'HP',
      name: 'Hp Envy 15- 11Th Gen Intel Core I9/32Gb/1Tb Ssd/15.6 Inches 400 Nits,4K Amoled Touch, Tuv + Windows 11 Pro',
    ...
    },
    {
      id: '11',
      brand: 'LEOTUDE',
      name: 'LEOTUDE Regular Fit Half Sleeve Polo T-Shirt for Men',
    ...
    },
    {
      id: '12',
      brand: 'LEOTUDE',
      name: 'Printed Large-scale T-shirt',
    ...
    },
    {
      id: '14',
      brand: 'Generic',
      name: 'Women Ladies Girls Winter Wear Round Neck Self Design Woolen Dori Design Poncho? Black',
    ...
    },
    {
      id: '14',
      brand: 'Koh Koh',
      name: 'KOH KOH Womens Long Maxi Summer Floral Print Short Sleeve Flowy Modest Maxi Dress Gown',
    ...
    },
    {
      id: '18',
      brand: 'Adidas',
      name: 'Adidas Unisex-Adult Courtflash M Tennis Shoe',
    ...
    },
    {
      id: '19',
      brand: 'Dr Smith',
      name: 'Dr Smith 3 Seater Sofa Com Bed with 4 Cushions Incuded-Washab',
    ...
    },
    {
      id: '20',
      brand: 'Elitism',
      name: 'Elitism Modern & Classic 3 Seater Chesterfield Sectional Sofa ',
    ...
    },
    {
      id: '21',
      brand: 'RM',
      name: 'RM Home Two Seater Sofa Leatherette Grey',
    ...
    },
    {
      ...
      name: 'Metallika Centerville Three Seater Sofa cum Bed with Mattress (Glossy Finish, Brown, Metal) By FurnitureKraft',
    ...
    },
    {
      id: '23',
      brand: 'Funskool',
      name: 'Funskool Games - Scotland Yard, A Compelling Detective And Strategy,Animal Board Game for Kids & Family, 2 - 3 Players, 10 & Above(Multicolor)',
    ...
    },
    {
      id: '24',
      brand: 'Skillmatics',
      name: 'Skillmatics Card Game : Guess in 10 Marvel Edition | Gifts for Ages 8 and Up | Super Fun Spider-Man, Iron Man Game | Avengers Card Set',
    ...
    },
    {
      id: '25',
      brand: 'Amisha',
      name: 'Amisha Gift Gallery Video Games for Kids Wireless 4GB Video Game for Kids, 4k Ultra HD Classic Games',
    ...
    },
    {
      id: '26',
      brand: 'GIFTEO',
      name: 'GIFTEO Video Game for Kids, Handheld Sup 400 in 1 Mario, Super Mario, Contra and Other 400 Games',
    ...
    },
    {
      id: '27',
      brand: 'Lifelong',
      name: 'Lifelong 26T Freeride Cycle with Dual Disc Suspension',
    ...
    },
    {
      id: '29',
      brand: 'Decsix',
      name: 'Decsix Folding Mountain Bike, 26 inch 21 Speed Full Suspension MTB Bicycle for Adult',
    ...
    },
    {
      id: '30',
      brand: 'Blaupunkt',
      name: 'Blaupunkt BH51 ANC Moksha Bluetooth Wireless On Ear Headphones with 32 Hrs* Long Playtime I 25dB Active Noise Cancellation',
    ...
    },
    {
      id: '33',
      brand: 'boAt',
      name: 'boAt Wave Call Smart watch electronics, Smart Talk with Advanced Dedicated',
    ...
    },
    {
      id: '36',
      brand: 'Cadbury',
      name: 'Cadbury Diwali Silk potli pack, 343 g',
    ...
    },
    {
      id: '37',
      brand: 'Cadbury',
      name: 'Cadbury Celebrations Premium Selections Chocolates Gift Pack, Assorted, 268 g',
    ...
    },
    {
      id: '39',
      brand: 'Cadbury',
      name: 'Cadbury Choclairs Gold , 605g (110 Units * 5.5 g EACH)',
      description: 'This assorted pack contains 1 unit of 5-Star 3D-42g, 2 unit of Cadbury Dairy Milk-23g, 1 units of Cadbury Dairy Milk Crackle-36g, 2 units of Cadbury Dairy Milk Fruit & Nut-36g and 2 units of Cadbury Dairy Milk Roasted Almond-36g',
      price: 195,
    ...
    },
    {
      id: '40',
      brand: 'Lakme',
      name: 'Lakme 9 to 5 CC Cream Mini, 01 - Beige, Light Face Makeup',
    ...
    },
    {
      id: '41',
      brand: 'Maybelline',
      name: 'Maybelline New York Concealer, Dark Circles and Blemish Eraser, Ultra Blendable',
      description: 'Provides UV Protection. Organic Type : Synthetic Moisturizes Conceals Gives Smooth Coverage Lightens Skin Evens skin tone',
      price: 419,
    ...
    },
    {
      id: '42',
      brand: 'TrustBasket',
      name: 'TrustBasket Organic Vermicompost Fertilizer Manure for Plants - 10 KG',
    ...
    },
    {
      id: '43',
      brand: 'U-Plant',
      name: 'U-Plant Organic Manure with NPK for Plants & Home Gardening - 900 gm',
      description: 'Buy Original, sold and fulfilled by Trust basket*** Improves Soil Aeration Enriches Soil With Micro-Organisms (Adding Enzymes Such As Phosphatase And Cellulase) Microbial Activity In Worm Castings Is 10 To 20 Times Higher Than In The Soil And Organic Matter That The Worm Ingests Attracts Deep-Burrowing Earthworms Already Present In The Soil',
      price: 254,
    ...
    },
    {
      id: '44',
      brand: 'DARIT',
      name: 'DARIT Tooth Rake Garden Tool, Cast- Duty Gardening Rake',
    ...
    },
    {
      id: '45',
      brand: 'DeoDap',
      name: 'DeoDap Stainless Steel Garden Plant Branch Scissors',
      description: 'High strength and very sharp, cutting effortlessly, even if after a lot of cutting never worrying about becoming dull. Ergonomic Design: Lightweight Stainless Steel ergonomic handles with rubber cushioning for a comfortable yet solid grasp. Great for trimming a variety of bushes and hedges. They are excellent universal shear and are very good gardening tool Ultra Sharp Blades: These quality snips come with stainless steel precision-sharpened blades and are ready to tackle all of your deadheading, trimming, and shaping needs for your roses, annuals, vegetable and small flower gardens',
      price: 304,
    ...
    },
    {
      id: '46',
      brand: 'By M.R. Dileep',
      name: 'Tourism: Concepts, Theory and Practice',
    ...
    },
    {
      id: '49',
      brand: 'UE Premium',
      name: 'UE Premium Petrol Fuel Treatment and Injector Cleaner - 354 ml Car Care/Car',
    ...
    },
    {
      id: '50',
      brand: 'UE Elite',
      name: 'UE Elite Dashboard and Polish Cleaner For All Cars and Bike - Dry to touch and Rich',
      description: 'Keeps engine clean and free of deposits Enhances mielage and effeciency of older engine Enhances life of fuel tank and engine parts Petrol fuel tank additive is a multi functional additive with unique detergent dispersant formula for all petrol engines. Avoid eye and skin contact. Avoid prolonged breathing of vapour. Wash hands thoroughly after handling. Use in a well ventilated area. Keep container closed when not in use. Do not injest.',
      price: 139,
